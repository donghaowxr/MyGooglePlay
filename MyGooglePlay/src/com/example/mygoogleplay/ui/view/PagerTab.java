...
import com.example.mygoogleplay.ui.activity.BaseActivity;
...
public class PagerTab extends ViewGroup {
	...
	private void init() {
		//把一个值从dip转换成px
		mIndicatorHeight = UIUtils.dpi2px(mIndicatorHeight);
		mDividerPadding = UIUtils.dpi2px(mDividerPadding);
		mTabPadding = UIUtils.dpi2px(mTabPadding);
		mDividerWidth = UIUtils.dpi2px(mDividerWidth);
		mTabTextSize = UIUtils.dpi2px(mTabTextSize);
		//创建一个scroller
